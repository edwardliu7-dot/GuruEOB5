...
export function PresensiHarian() {
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 p-6 overflow-y-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-6">
            <div>
              <h1 className="text-2xl font-bold text-slate-800">Presensi Harian Siswa</h1>
              <p className="text-slate-500 mt-1">Pencatatan kehadiran kelas aktif</p>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-white rounded-xl border border-orange-100 p-4 shadow-sm flex items-center gap-4 relative overflow-hidden group">
              ...
              <div className="w-12 h-12 rounded-full bg-orange-100 flex items-center justify-center text-orange-500 z-10">
            ...
            <div className="bg-white rounded-xl border border-red-100 p-4 shadow-sm flex items-center gap-4 relative overflow-hidden group">
              ...
              <div className="w-12 h-12 rounded-full bg-red-100 flex items-center justify-center text-red-600 z-10">
                          ...
                          <div className="flex items-center justify-center gap-2">
                            <button
                              ...
                              className={`px-4 py-1.5 rounded-full text-xs font-semibold flex items-center gap-1.5 transition-all ${
                                s.status === "Hadir"
                                  ? "bg-emerald-100 text-emerald-700 ring-1 ring-emerald-500 shadow-sm"
                                  : "bg-white text-slate-500 ring-1 ring-slate-200 hover:bg-slate-50"
                              }`}
                            >
                              Hadir {s.status === "Hadir" && <Check className="w-3 h-3" />}
                            </button>
                            <button
                              onClick={() => handleStatusChange(s.id, "Sakit")}
                              className={`px-4 py-1.5 rounded-full text-xs font-semibold flex items-center gap-1.5 transition-all ${
                                s.status === "Sakit"
                                  ? "bg-orange-100 text-orange-700 ring-1 ring-orange-500 shadow-sm"
                                  : "bg-white text-slate-500 ring-1 ring-slate-200 hover:bg-slate-50"
                              }`}
                            >
                              Sakit {s.status === "Sakit" && <Check className="w-3 h-3" />}
                            </button>
                            <button
                            ...
                            >
                              Izin {s.status === "Izin" && <Check className="w-3 h-3" />}
                            </button>
                            <button
                              onClick={() => handleStatusChange(s.id, "Alpa")}
                              className={`px-4 py-1.5 rounded-full text-xs font-semibold flex items-center gap-1.5 transition-all ${
                                s.status === "Alpa"
                                  ? "bg-red-100 text-red-700 ring-1 ring-red-500 shadow-sm"
                                  : "bg-white text-slate-500 ring-1 ring-slate-200 hover:bg-slate-50"
                              }`}
                            >
                              Alpa {s.status === "Alpa" && <Check className="w-3 h-3" />}
                            </button>
                          </div>
                        </td>
                      </tr>
            ...
            <div className="w-full lg:w-[320px] bg-white border border-slate-200 rounded-xl shadow-sm flex flex-col shrink-0">
              ...
              <div className="p-5 space-y-6">
                ...
                <div className="relative pl-4 border-l-2 border-orange-200">
                  ...
                  <div className="text-xs font-bold text-slate-500 mb-1">Rab, 22 Jul</div>
                ...
                <div className="relative pl-4 border-l-2 border-emerald-200">
                  ...
                  <div className="text-xs font-bold text-slate-500 mb-1">Sel, 21 Jul</div>
                ...
                <div className="relative pl-4 border-l-2 border-orange-200">
                  <div className="absolute w-2.5 h-2.5 bg-orange-400 rounded-full -left-[6px] top-1.5 ring-4 ring-white"></div>
                  <div className="text-xs font-bold text-slate-500 mb-1">Sen, 20 Jul</div>
                  <div className="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-red-50 text-red-600 border border-red-100 mb-2">
                    2 Tidak Hadir
                  </div>
                  <div className="flex gap-2 flex-wrap">
